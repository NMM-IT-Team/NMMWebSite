...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.Platform.PhysicalLayoutManager+SeekAndSnapScroller, Xamarin.Forms.CarouselView.Android", PhysicalLayoutManager_SeekAndSnapScroller.class, __md_methods);
	}
	...
	public PhysicalLayoutManager_SeekAndSnapScroller (android.content.Context p0)
	{
		...
		if (getClass () == PhysicalLayoutManager_SeekAndSnapScroller.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.Platform.PhysicalLayoutManager+SeekAndSnapScroller, Xamarin.Forms.CarouselView.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
